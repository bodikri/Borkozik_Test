...
public class RouteOverlay extends MapOverlay
{
	...
	public RouteOverlay(final Activity mapActivity)
	{
		...
		linePaint.setColor(ContextCompat.getColor(context, R.color.routeline));//linePaint.setColor(context.getResources().getColor(R.color.routeline));
		//import android.support.v4.content.ContextCompat; - трябва да се добави в import
		fillPaint = new Paint();
		fillPaint.setAntiAlias(false);
		fillPaint.setStrokeWidth(1);
		fillPaint.setStyle(Paint.Style.FILL_AND_STROKE);
		fillPaint.setColor(ContextCompat.getColor(context, R.color.routewaypoint));
		borderPaint = new Paint();
		borderPaint.setAntiAlias(false);
		borderPaint.setStrokeWidth(1);
		borderPaint.setStyle(Paint.Style.STROKE);
		borderPaint.setColor(ContextCompat.getColor(context, R.color.routeline));
		textPaint = new Paint();
		...
		textPaint.setColor(ContextCompat.getColor(context, R.color.routewaypointtext));
		...
		textFillPaint.setColor(ContextCompat.getColor(context, R.color.routeline));
