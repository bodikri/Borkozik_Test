...
public class ScaleOverlay extends MapOverlay
{
	...
	protected void onDraw(Canvas c, MapView mapView, int centerX, int centerY)
	{
		...
		int cx = - mapView.lookAheadXY[0] - centerX + 30;//int cx = - mapView.lookAheadXY[0]
		int cy = - mapView.lookAheadXY[1] - centerY + mapView.viewArea.bottom - 30;//int cy = - mapView.lookAheadXY[1] - centerY
		int cty = -10;
