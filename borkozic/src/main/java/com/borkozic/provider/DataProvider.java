...
public class DataProvider extends ContentProvider
{
	...
	public String getType(Uri uri)
	{
		...
		{
			case MAPOBJECTS:
				return "vnd.android.cursor.dir/vnd.com.borkozic.provider.mapobject";
			case MAPOBJECTS_ID:
				return "vnd.android.cursor.item/vnd.com.borkozic.provider.mapobject";
			case ICONS_ID:
				return "vnd.android.cursor.item/vnd.com.borkozic.provider.icon";
			default:
