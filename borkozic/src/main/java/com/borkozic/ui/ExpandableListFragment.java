...
import androidx.fragment.app.Fragment;//import androidx.core.app.Fragment;

/**
 * @author Khoa Tran
 * 
 *
 * @see androidx.fragment.app.Fragment;//@see androidx.core.app.ListFragment
...
public class ExpandableListFragment extends Fragment
    ...
    protected void setListContainer(View view)
    {
    	mExpandableListContainer = view;
    }

    protected void setProgressContainer(View view)
    {
