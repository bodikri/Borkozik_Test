...
public class GpxFiles
{
	...
	public static void saveTrackToFile(final File file, final Track track) throws IOException
	{
		...
		serializer.text(Borkozic.getDeviceName());
...
class GpxParser extends DefaultHandler
{
	...
	public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException
	{
		...
		if (localName.equalsIgnoreCase(WPT) && waypoints != null)
		{
			...
			waypoint.altitude = Double.parseDouble(attributes.getValue(ELE));//elev is added from me
		}
		// <rte>
		...
		if (localName.equalsIgnoreCase(RTEPT) && route != null)
		{
			...
			rtwpt.altitude = Double.parseDouble(attributes.getValue(ELE));//elev is added from me
		}
		// <trk>
		...
		{//elev is added from me
			track.addPoint(continous, Double.parseDouble(attributes.getValue(LAT)), Double.parseDouble(attributes.getValue(LON)), Double.parseDouble(attributes.getValue(ELE)), 0.0, 0.0, 0.0, 0);
